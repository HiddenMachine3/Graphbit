...
class TestNeighborQueries:
    ...
    def test_get_outgoing_neighbors_single_edge(self):
        ...
        node_a = Node(id="A", project_id="test_project_1", topic_name="Topic A")
        node_b = Node(id="B", project_id="test_project_1", topic_name="Topic B")
        
        graph.add_node(node_a)
        graph.add_node(node_b)
        graph.add_edge(Edge(from_node_id="A", to_node_id="B", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
    ...
    def test_get_outgoing_neighbors_multiple_edges(self):
        ...
        for node_id in ["A", "B", "C", "D"]:
            graph.add_node(Node(id=node_id, project_id="test_project_1", topic_name=f"Topic {node_id}"))
        
        # A -> B, A -> C, A -> D
        graph.add_edge(Edge(from_node_id="A", to_node_id="B", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="A", to_node_id="C", project_id="test_project_1", weight=0.5, type=EdgeType.DEPENDS_ON))
        graph.add_edge(Edge(from_node_id="A", to_node_id="D", project_id="test_project_1", weight=0.5, type=EdgeType.APPLIED_WITH))
    ...
    def test_get_incoming_neighbors_multiple_edges(self):
        ...
        # A -> D, B -> D, C -> D
        graph.add_edge(Edge(from_node_id="A", to_node_id="D", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="B", to_node_id="D", project_id="test_project_1", weight=0.5, type=EdgeType.DEPENDS_ON))
        graph.add_edge(Edge(from_node_id="C", to_node_id="D", project_id="test_project_1", weight=0.5, type=EdgeType.APPLIED_WITH))
...
class TestPathExistence:
    ...
    def test_path_exists_multi_hop(self):
        ...
        graph.add_edge(Edge(from_node_id="A", to_node_id="B", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="B", to_node_id="C", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
    ...
    def test_path_exists_respects_max_hops(self):
        ...
        graph.add_edge(Edge(from_node_id="A", to_node_id="B", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="B", to_node_id="C", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="C", to_node_id="D", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
    ...
    def test_path_exists_with_edge_type_filter(self):
        ...
        graph.add_edge(Edge(from_node_id="A", to_node_id="B", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="B", to_node_id="C", project_id="test_project_1", weight=0.5, type=EdgeType.DEPENDS_ON))
    ...
    def test_path_exists_handles_cycles(self):
        ...
        graph.add_edge(Edge(from_node_id="A", to_node_id="B", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="B", to_node_id="C", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="C", to_node_id="A", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
...
class TestShortestPath:
    ...
    def test_shortest_path_chooses_shortest(self):
        ...
        graph.add_edge(Edge(from_node_id="A", to_node_id="B", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="B", to_node_id="D", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="A", to_node_id="C", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="C", to_node_id="E", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
        graph.add_edge(Edge(from_node_id="E", to_node_id="D", project_id="test_project_1", weight=0.5, type=EdgeType.PREREQUISITE))
